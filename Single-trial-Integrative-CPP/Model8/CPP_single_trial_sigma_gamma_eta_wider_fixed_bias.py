...
true_vs_estimated(true_params, param_means, ['mu_drift', 'boundary', 'tau', 'sigma', 'gamma', 'eta'], filename="../true_vs_estimate/CPP_single_trial_sigma_gamma_eta_wider_fixed_bias")
