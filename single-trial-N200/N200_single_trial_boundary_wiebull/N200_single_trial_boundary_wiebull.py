...
true_vs_estimated(true_params, param_means, ['drift', 'boundary', 'beta', 'mu_tau_e', 'tau_m', 'sigma', 'varsigma', 'lam'], filename="../true_vs_estimate/N200_single_trial_boundary_lam")
