...
def diffusion_trial(drift, boundary, beta, mu_tau_e, tau_m, sigma, varsigma, theta, dc=1.0, dt=.005):
    ...
    z1 = np.random.normal(tau_e_trial, sigma)   
    z2 = np.random.uniform(.05, .4)
    # random generation
...
true_vs_estimated(true_params, param_means, ['drift', 'boundary', 'beta', 'mu_tau_e', 'tau_m', 'sigma', 'varsigma', 'theta'], filename="../true_vs_estimate/NDDM_mixture")
