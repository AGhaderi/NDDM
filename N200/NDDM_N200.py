...
def prior(batch_size):
    ...
    p_samples = np.random.uniform(low=(-3.0, 0.5, 0.1, 0.05, 0.06, 0.0 ),
                                  high=(3.0, 2.5, 0.9, 0.6,  0.8,  0.3), size=(batch_size, n_parameters))
...
trainer = ParameterEstimationTrainer(
    ...
    checkpoint_path="checkpoint/NDDM_N200"
)
...
true_vs_estimated(true_params, param_means, ['drift', 'boundary', 'beta', 't_e', 't_m', 'sigma_e'], filename="true_vs_estimate/NDDM_N200")
