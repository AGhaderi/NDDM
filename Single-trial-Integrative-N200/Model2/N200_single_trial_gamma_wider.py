...
def prior(batch_size):
    ...
    p_samples = np.random.uniform(low=(-3.0, 0.5, 0.1, 0.05, 0.06, 0.0, 0.0, 0.0),
                                  high=(3.0, 2.0, 0.9, 0.6,  0.8,  0.3, 0.3, 3.0), size=(batch_size, n_parameters))
...
true_vs_estimated(true_params, param_means, ['drift', 'boundary', 'beta', 'mu_tau_e', 'tau_m', 'sigma', 'varsigma', 'gamma'], filename="../true_vs_estimate/N200_single_trial_gamma_wider")
