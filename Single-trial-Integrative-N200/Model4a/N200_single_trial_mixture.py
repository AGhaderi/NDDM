...
# Variable n_trials
def prior_N(n_min=150, n_max=400):
    """
...
true_vs_estimated(true_params, param_means, ['drift', 'boundary', 'beta', 'mu_tau_e', 'tau_m', 'tau', 'sigma_e', 'sigma_k', 'varsigma', 'k', 'theta'], filename="../true_vs_estimate/N200_single_trial_mixture")
