...
true_vs_estimated(true_params, param_means, ['drift', 'boundary', 'beta', 'mu_tau_e', 'tau_m', 'sigma_e', 'varsigma', 'theta'], filename="../true_vs_estimate/N200_single_trial_mixture_compact")
